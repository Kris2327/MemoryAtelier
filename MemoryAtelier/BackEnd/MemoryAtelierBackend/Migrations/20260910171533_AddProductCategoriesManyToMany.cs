...
{
    /// <inheritdoc />
    public partial class AddProductCategoriesManyToMany : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            // Preserve every product's existing single category as its first entry in the new many-to-many table.
